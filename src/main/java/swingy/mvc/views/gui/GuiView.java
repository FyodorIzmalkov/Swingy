...
public class GuiView extends JFrame implements InterfaceView {
    private final GuiHeroPicker swingHeroPicker;
    ...
    public GuiView(Controller controller, GuiHeroPicker swingHeroPicker, MainPanel mainPanel) {
        super("Swingy");
        ...
        KeyAdapter keySupporter = new KeyListener();
        ...
        public void keyPressed(KeyEvent e) {
            if (controller.getHero() != null) {
                if ((e.getKeyCode() > 36 && e.getKeyCode() < 41)) {
                    ...
                    controller.keyPressed(CHANGE_VIEW_CODE);
                }
            }
        }
    }
